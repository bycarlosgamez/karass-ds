...
const buttonStyles = cva(
  'inline-flex items-center gap-1.5 font-semibold rounded border transition-colors px-3 py-1.5 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2',
  {
    variants: {
      variant: {
        primary:
